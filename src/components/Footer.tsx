        ...
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-500 hover:text-gray-900 transition-colors">Features</a></li>
              ...
              <li><a href="#" className="text-gray-500 hover:text-gray-900 transition-colors">Status</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-500 hover:text-gray-900 transition-colors">DPA</a></li>
              <li><a href="#" className="text-gray-500 hover:text-gray-900 transition-colors">Security</a></li>
            </ul>
          </div>
        </div>
